                    ...
                    <div className="modal-content">
                        ...
                        <form id="formulario" onSubmit={acaoCadastrar}
                            ...
                            <div className="modal-body">
                                ...
                                <div className="mb-3">
                                    <label htmlFor="selectAtivo" className="form-label">Ativo</label>
                                    <select type="text" className="form-control"
                                        id="selectAtivo"
                                        required name="ativo" value={objeto.ativo}
                                        onChange={handleChange} >
                                            <option disable="true" value="">Selecione uma opção</option>
                                ...
                                <div className="mb-3">
                                    <label htmlFor="selectCategoria" className="form-label">Categoria</label>
                                    <select type="text" className="form-control"
                                        id="selectCategoria"
                                ...
                                <div className="mb-3">
                                    <label htmlFor="txtEstoque" className="form-label">Estoque</label>
                                ...
                                <div className="mb-3">
                                    <label htmlFor="txtDataCadastro" className="form-label">Data Cadastro</label>
